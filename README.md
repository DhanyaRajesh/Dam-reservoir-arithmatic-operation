# Dam-reservoir-arithmatic-operation
...
Here the task is to write Python program using less number of lines of code to find the current water level of the reservoir using the given data
